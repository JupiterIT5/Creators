  ...
  return (
    <div className="message">
      <div className="my__message">
        <h2>Начните новое обсуждение</h2>
        <div className="send__message">
          <input type="text" placeholder="Опишите вашу прoблему или идею" />
          <button className="send-message">Начать</button>
        </div>
      </div>
      <div className="forum__container">
        <h2>Или присоединитесь к существующим</h2>
        <div className="comment__container">
          ...
          <div className="comment__container--card">
            <div className="comment">
              ...
              <p>
                Хочу стать круче студийной банды, нужны люди в команду. У нас
                есть печеньки!
              </p>
            </div>
            <div className="user-comment">
